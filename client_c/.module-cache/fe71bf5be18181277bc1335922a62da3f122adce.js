...
var FcPlaylistsTableHeader = React.createClass({displayName: 'FcPlaylistsTableHeader',
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "FcPlaylistsTableHeader", style: style}, 
        React.createElement("select", {className: "FcPlaylistChooser", ref: "chooser", onChange: this.handleChange, style: style}, 
          options
        )
      )
    );
